...
$card_value = { "two" => 2, "three" => 3, "four" => 4, "five" => 5, "six" => 6, 
...
def run_game
  ...
  puts score(hand) > 21 ? "You busted with: #{score(hand)}" : "You scored: #{score(hand)}"
  
end

# To run game un-comment below!
