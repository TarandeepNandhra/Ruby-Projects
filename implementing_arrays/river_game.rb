...
river = "-----,--C--,CC-CC,CC-CC"
# River is an array of strings, a 2D array
river = river.split(",")

# River counter
river_count = 0
# player_position horizontal
player_position = 2
# Keep previous value to compare
prev = river[river_count][player_position]
# Set player to center of river
river[river_count][player_position] = "P"
...
while true do
  ...
  # Replace P so Player's path is not displayed
  river[river_count][player_position] = prev
  
  puts "Would you like to go left, right or neither."
  
  input = gets.chomp
  
  if river_count == river.length - 1
    puts "You survived!"
    break
  end
